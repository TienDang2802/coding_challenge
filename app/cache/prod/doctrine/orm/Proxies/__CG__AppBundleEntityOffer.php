 ...
 */
class Offer extends \AppBundle\Entity\Offer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Offer' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Offer' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\Offer' . "\0" . 'room');
        }
