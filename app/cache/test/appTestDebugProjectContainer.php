...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'core_manager' => 'getCoreManagerService',
            ...
            'offer_controller' => 'getOfferControllerService',
            'offer_manager' => 'getOfferManagerService',
            ...
            'room_finder' => 'getRoomFinderService',
    ...
    /**
     * Gets the 'core_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\CoreManager A AppBundle\Manager\CoreManager instance.
     */
    protected function getCoreManagerService()
    {
        return $this->services['core_manager'] = new \AppBundle\Manager\CoreManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sym_hotel', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ce4dd9ad11e9b16861d1ecb5d71aeb6da7fdf8fd9f386e7cead651b2ca164937');
    ...
    /**
     * Gets the 'offer_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\OfferController A AppBundle\Controller\OfferController instance.
     */
    protected function getOfferControllerService()
    {
        return $this->services['offer_controller'] = new \AppBundle\Controller\OfferController($this->get('templating'), $this->get('room_finder'), $this->get('offer_manager'));
    }

    /**
     * Gets the 'offer_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\OfferManager A AppBundle\Manager\OfferManager instance.
     */
    protected function getOfferManagerService()
    {
        return $this->services['offer_manager'] = new \AppBundle\Manager\OfferManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'room_finder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Manager\RoomManager A AppBundle\Manager\RoomManager instance.
     */
    protected function getRoomFinderService()
    {
        return $this->services['room_finder'] = new \AppBundle\Manager\RoomManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56cc064c3521a9.31773179')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'sym_hotel',
            'test.database_name' => 'dreamcheaper_test',
